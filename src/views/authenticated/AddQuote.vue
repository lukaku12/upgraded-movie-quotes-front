<template>
  ...
  <div
    class="fixed overflow-y-auto max-h-screen animate-pop-up md:animate-none w-screen bg-landing-background-reverse h-auto top-0 right-0 pb-10 text-white z-50 max-w-[961px] md:left-[50%] md:translate-x-[-50%] md:top-[100px] md:rounded-[12px] font-bold"
  >
